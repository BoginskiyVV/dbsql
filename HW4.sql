...
-- SELECT shops.id, shopname, cats.name
-- FROM shops
-- LEFT JOIN cats  
-- ON shops.id = cats.shops_id WHERE cats.name != 'Murzik' AND cats.name != 'Zuza' OR cats.name IS NULL
...
(SELECT shops_id FROM cats WHERE (cats.name = 'Murzik' OR cats.name = 'Zuza'));
